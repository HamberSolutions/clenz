        ...
        <Container fluid>
          <Row>
            <Col lg={12} md={12} sm={12} style={{ padding: "0px" }}>
              <Slider {...settings}>
                <div>
                  <img className="home_main_img" src={Photo5} alt="im" />
                </div>
                <div>
                  <img className="home_main_img" src={Photo7} alt="im" />
                </div>
                <div>
                  <img className="home_main_img" src={Photo8} alt="im" />
                </div>
              </Slider>
            </Col>
          </Row>
          <Row>
            <Col>
              <div className="slider_text_div">
                <h1 className="slider_heading">Clenz Spa & Saloon</h1>
                <p className="slider_para">
                  Welcome to Clenz Spa & Saloon, We're Providing prociding all
                  type of Massages. Our Staff are fully Professional & Trained
                </p>
              </div>
            </Col>
          </Row>
      ...
      <section className="home_second_section">
        <Container>
          ...
          <Row className="third_row">
            <Col lg={4} md={4} sm={12}>
              <img className="pic_1" src={Photo4} alt="im" />
            </Col>
            <Col lg={4} md={4} sm={12}>
              <img className="home_icons" src={icon1} alt="im" />
            ...
            <Col lg={4} md={4} sm={12}>
              <img className="pic_1" src={Photo3} alt="im" />
            </Col>
          </Row>
          <Row>
            <Col lg={4} md={4} sm={12}>
              <img className="home_icons" src={icon2} alt="im" />
            ...
            <Col lg={4} md={4} sm={12}>
              <img className="pic_1" src={Photo6} alt="im" />
            </Col>
            <Col lg={4} md={4} sm={12}>
              <img className="home_icons" src={icon3} alt="im" />
          ...
          <Row>
            <Col>
              ...
              <div className="appoint_div">
                <Link className="appoint_button" to="/services">
            ...
            <Col lg={4} md={4} sm={12}>
              <Card className="card_data">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Forget Your Stress And Relax At Clenz Spa & Saloon in Abu
                    Dhabi
                  </Card.Text>
                  <Card.Text>AED. 249 / 60 minutes session</Card.Text>

                  <Link to="/services">
                    <Button className="card_buttons" variant="primary">
                      Book Now
                    </Button>
                  </Link>
                </Card.Body>
            ...
            <Col lg={4} md={4} sm={12}>
              <Card className="card_data">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Leave your worries and distractions behind and focus on the
                    present moment with your partner
                  </Card.Text>
                  <Card.Text>AED. 449 / 60 minutes session</Card.Text>
            ...
            <Col lg={4} md={4} sm={12}>
              <Card className="card_data">
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    It's a combination or traditional hot stone and ventosa
                    therapy.
                  </Card.Text>
                  <Card.Text>AED. 449 / 90 minutes session</Card.Text>
