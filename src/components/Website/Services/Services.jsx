  ...
  return (
    <div className="services_back">
      ...
      <div className="scroll_div">
        ...
        <button className="scroll_button" onClick={handleScroll}>
          Book Now
        </button>
      </div>
        ...
        <Container>
          ...
          <Row>
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Relaxation Massage - 60 minutes", 249)
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Relaxation Massage - 90 minutes", 349)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Deep Tissue Massage- 60 minutes", 249)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Deep Tissue Massage- 90 minutes", 349)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Couple Massage- 60 minutes each session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "MADEROTHERAPHY ANTI CELLULITE(wooden treatment)- 60 minutes",
                            299
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Clenz Signature Massage-120 minutes",
                            549
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Luxurious Services- 2hr 30 minutes", 449)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                            "Luxurious Services- 2hr 30 minutes"
                          ) && (
                            <div
                              style={{
                                width: "30px",
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Refreshing Packages- 120 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Group of Faith Special- 3hr 45 min, 2 services",
                            849
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "The Star of Clenz Spa- 120 minutes session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Solemen Prayer Massage- 105 minutes session",
                            299
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Under The Lanterns Special- 105 minutes session ",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Crescent Mood Massage- 105 minutes session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Deep Tissue Massage- 90 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Relaxation Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Lymphatic Drainage Massage- 90 minutes massage",
                            399
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Maderotherapy Slimming(wood traetment)- 90 minutes session",
                            399
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Lymphatic Drainage Massage- 60 minutes session",
                            279
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Hotstone & Relax- 45 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Cupping & Relax- 45 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "lymphatic Drainage Massage- 45 minutes session",
                            199
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Mediotherapy Anti Cellulite- 60 minutes ",
                            299
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Pre & Post Natal Massage- 90 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Pre & Post Natal Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Slimming Massage- 90 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Slimming Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Reflexology Massage- 90 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Reflexology Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Sports Massage- 90 minutes session", 349)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                            "Sports Massage- 90 minutes session"
                          ) && (
                            <div
                              style={{
                                width: "30px",
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Sports Massage- 60 minutes session", 249)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                            "Sports Massage- 60 minutes session"
                          ) && (
                            <div
                              style={{
                                width: "30px",
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Hot Oil Massage Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Traditional Thai Massage- 90 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Traditional Thai Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Aroma Therapy  Massage- 90 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Aroma Therapy Massage- 60 minutes session",
                            249
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "4 Hands Massage- 60 minutes session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Couple Massage- 120 minutes session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Couple Massage- 180 minutes session",
                            549
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Cupping & Relax- 60 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Hotstone  & Relax- 60 minutes session",
                            349
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Full Body Scrub & Relax- 90 minutes session",
                            349
                          )
                        }
                      >
                    ...
                    <Col lg={9} md={9} sm={9}>
                      ...
                      <p className="time_headings">90 minutes session</p>
                      <p className="para">
                        Body scrubs remove dead skin cells, and so provide
                        several benefits: They allow your skin to absorb
                        moisturizer better. By doing dead skin cell buildup, any
                        moisturizer applied afterward will soak into the skin
                        more thoroughly. They unclog pores and prevent ingrown
                        hairs.
                      </p>
                    </Col>
                    <Col>
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Cupping & Relax- 90 minutes session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Hotstone & Relax- 90 minutes session",
                            449
                          )
                        }
                      >
                    ...
                    <Col lg={9} md={9} sm={9}>
                      ...
                      <p className="time_headings">90 minutes session</p>
                      <p className="para">
                        A primary benefit associated with the practice is that
                        of stimulating blood flow in the circulatory system
                        through the heat and movement of the stones.Stone
                        massages also ease muscle pain and often, the presence
                        of muscle tension and spasms through reducing
                        inflammation and relaxing muscles through a combination
                        of both the heat and movement experience during the
                        practice to access deeper tissues.
                      </p>{" "}
                    </Col>
                    <Col>
                      <h6 className="price">AED 499</h6>
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Ear Candling- 20 minutes session", 49)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                            "Ear Candling- 20 minutes session"
                          ) && (
                            <div
                              style={{
                                width: "30px",
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Body Scrub- 30 minutes session", 99)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                            "Body Scrub- 30 minutes session"
                          ) && (
                            <div
                              style={{
                                width: "30px",
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick("Head Massage- 30 minutes session", 99)
                        }
                      >
                        <div className="select_btn">
                          {selectedItems.includes(
                            "Head Massage- 30 minutes session"
                          ) && (
                            <div
                              style={{
                                width: "30px",
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Clenz Signature- 90 minutes session",
                            449
                          )
                        }
                      >
                  ...
                  <div className="mobile_columns">
                    <Col lg={1} md={1} sm={1}>
                      <button
                        ...
                        onClick={() =>
                          handleClick(
                            "Clenz Signature Massage- 120 minutes session",
                            549
                          )
                        }
                      >
                    ...
                    <Col lg={9} md={9} sm={9}>
                      ...
                      <p className="time_headings">120 minutes session</p>
                      <p className="para">
                        It is a combination of hot stone, traditional ventosa
                        and massage.
                      </p>
                    </Col>
            ...
            <Col lg={5} md={5} sm={12} className="right_col">
              <div
                id="servicescroll"
                className="ticket_back_div  scroll-target"
                ref={scrollRef}
              >
                <Row>
                  <Col>
